...
from assignment_chat.tools_axolotl import get_axolotl_facts
from assignment_chat.tools_gameofthrones import get_got_facts
...
tools = [get_axolotl_facts, get_got_facts]
